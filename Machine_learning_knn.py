...
excel = pd.read_excel("Crop.xlsx",engine='openpyxl')         # Importing our excel data from a specific file.
...
def wishMe():
    ...
    if hour >= 0 and hour < 12:
        a = "Good morning, enter the data mentioned above ", "Good morning sir, enter the data mentioned above", "Hello  Good Morning, enter the data mentioned above", "O, Good morning sir, enter the data mentioned above", "O, good morning, enter the data mentioned above", "Wow! Welcome back sir, enter the data mentioned above"
        speak(random.choice(a))
    elif hour >= 12 and hour < 18:
        b = "Good Afternoon, enter the data mentioned above ", "Good Afternoon sir, enter the data mentioned above", "Hello  Good Afternoon, enter the data mentioned above", "O, Good Afternoon sir, enter the data mentioned above", "O, good Afternoon, enter the data mentioned above", "Wow! Welcome back sir, enter the data mentioned above"
        speak(random.choice(b))
    else:

        c = "Good Evening , enter the data mentioned above", "Good Evening sir, enter the data mentioned above", "Hello  Good Evening, enter the data mentioned above", "O, Good Evening sir, enter the data mentioned above", "O, good Evening , enter the data mentioned above", "Wow! Welcome back  sir, enter the data mentioned above"
...
layout = [[sg.Text('                      Crop Recommendation Assistant', font=("Helvetica", 30), text_color = 'RED')],                                                    # Defining the layout of the Graphical User Interface. It consist of some text, Buttons, and blanks to take Input.
...
window = sg.Window('Crop Recommendation AI', layout)
